...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form:form class="login100-form validate-form" action="/dashboard" method="post" modelAttribute="student">
                <form:hidden path="id"/>
                ...
                <div class="wrap-input100 validate-input m-b-26">
                    ...
                    <form:input class="input100" type="text" path="stid"/>
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input m-b-26">
                    <span class="label-input100">Department:</span>
                    <form:input class="input100" type="text" path="dept"/>
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input m-b-26">
                    <span class="label-input100">Session:</span>
                    <form:input class="input100" type="text" path="session"/>
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input m-b-26">
                    <span class="label-input100">Mobile:</span>
                    <form:input class="input100" type="text" path="mobile"/>
                    <span class="focus-input100"></span>
                </div>
